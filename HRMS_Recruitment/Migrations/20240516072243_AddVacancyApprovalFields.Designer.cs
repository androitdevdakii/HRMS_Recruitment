...
namespace HRMS_Recruitment.Migrations
{
    ...
    [Migration("20240516072243_AddVacancyApprovalFields")]
    partial class AddVacancyApprovalFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS_Recruitment.Data.HRMS_User", b =>
                {
            ...
            modelBuilder.Entity("HRMS_Recruitment.Models.JobPositionVacancy", b =>
                {
                    ...
                    b.Property<bool>("IsSubmittedToDirForApproval")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSubmittedToHrForApproval")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HRMS_Recruitment.Data.HRMS_User", null)
                        .WithMany()
